...
#
# Created: Mon Apr 25 16:06:13 2016
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame_main_angio_capture_left.setMinimumSize(QtCore.QSize(230, 500))
        self.frame_main_angio_capture_left.setMaximumSize(QtCore.QSize(230, 16777215))
...
"}")
        ...
        self.verticalLayout = QtGui.QVBoxLayout(self.frame_main_angio_capture_center)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frame_main_angio_capture_center_2 = QtGui.QFrame(self.frame_main_angio_capture_center)
        self.frame_main_angio_capture_center_2.setMinimumSize(QtCore.QSize(500, 0))
        self.frame_main_angio_capture_center_2.setStyleSheet("QFrame#frame_main_angio_capture_center {\n"
" border: 1px solid #444;\n"
" padding: -8px;\n"
"}")
        self.frame_main_angio_capture_center_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_main_angio_capture_center_2.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_main_angio_capture_center_2.setObjectName("frame_main_angio_capture_center_2")
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.frame_main_angio_capture_center_2)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.frame_14 = QtGui.QFrame(self.frame_main_angio_capture_center_2)
        ...
        self.frame_37 = QtGui.QFrame(self.frame_14)
        self.frame_37.setMinimumSize(QtCore.QSize(400, 0))
        self.frame_37.setMaximumSize(QtCore.QSize(400, 16777215))
        self.frame_37.setFrameShape(QtGui.QFrame.NoFrame)
        self.frame_37.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_37.setObjectName("frame_37")
        self.horizontalLayout_16 = QtGui.QHBoxLayout(self.frame_37)
        ...
        self.toolButton_11.setIconSize(QtCore.QSize(64, 64))
        self.toolButton_11.setCheckable(True)
        self.toolButton_11.setChecked(True)
        self.toolButton_11.setObjectName("toolButton_11")
        self.horizontalLayout_16.addWidget(self.toolButton_11)
        self.toolButton_12 = QtGui.QToolButton(self.frame_37)
        icon5 = QtGui.QIcon()
        ...
        self.toolButton_12.setIconSize(QtCore.QSize(64, 64))
        self.toolButton_12.setCheckable(True)
        self.toolButton_12.setChecked(False)
        self.toolButton_12.setObjectName("toolButton_12")
        self.horizontalLayout_16.addWidget(self.toolButton_12)
        self.toolButton_13 = QtGui.QToolButton(self.frame_37)
        icon6 = QtGui.QIcon()
        ...
        self.toolButton_13.setIconSize(QtCore.QSize(64, 64))
        self.toolButton_13.setCheckable(False)
        self.toolButton_13.setChecked(False)
        self.toolButton_13.setObjectName("toolButton_13")
        self.horizontalLayout_16.addWidget(self.toolButton_13)
        self.toolButton_16 = QtGui.QToolButton(self.frame_37)
        icon7 = QtGui.QIcon()
        ...
        self.toolButton_16.setIconSize(QtCore.QSize(64, 64))
        self.toolButton_16.setCheckable(False)
        self.toolButton_16.setChecked(False)
        self.toolButton_16.setObjectName("toolButton_16")
        self.horizontalLayout_16.addWidget(self.toolButton_16)
        self.toolButton_17 = QtGui.QToolButton(self.frame_37)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/greys/images/grey_icons/reset.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButton_17.setIcon(icon8)
        self.toolButton_17.setIconSize(QtCore.QSize(64, 64))
        self.toolButton_17.setCheckable(False)
        self.toolButton_17.setChecked(False)
        self.toolButton_17.setObjectName("toolButton_17")
        self.horizontalLayout_16.addWidget(self.toolButton_17)
        ...
        self.frame_34 = QtGui.QFrame(self.frame_main_angio_capture_center_2)
...
"}")
        ...
        self.verticalLayout.addWidget(self.frame_main_angio_capture_center_2)
        ...
        self.frame_main_angio_capture_right.setMaximumSize(QtCore.QSize(230, 16777215))
...
"}")
        ...
        spacerItem5 = QtGui.QSpacerItem(175, 49, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
...
"}")
        ...
        self.toolButton_25.setIcon(icon12)
